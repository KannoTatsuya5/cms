            ...
            <div class="form-row offset-md-3">
                <div class="form-group col-md-6">
                    ...
                    <input name="item_name" type="hidden"
                        class="form-control  @if ($errors->has('item_name')) is-invalid @endif" id="book"
                        value="{{ old('item_name') }}">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input name="item_amount" type="hidden"
                        class="form-control @if ($errors->has('item_amount')) is-invalid @endif" id="amount"
                    ...
                    <input name="item_amount" type="text"
                        class="form-control @if ($errors->has('item_amount')) is-invalid @endif" id="amount"
                        value="{{ old('item_amount') }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input name="item_number" type="hidden"
                            class="form-control @if ($errors->has('item_number')) is-invalid @endif" id="number"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input name="published" type="hidden"
                            class="form-control @if ($errors->has('published')) is-invalid @endif" id="published"
                            value="{{ old('published') }}">
                        <div class="invalid-feedback">
